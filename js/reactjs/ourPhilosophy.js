...
class Ph_part extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: phClass
    }, /*#__PURE__*/React.createElement("dl", null, /*#__PURE__*/React.createElement("dt", null, phTitle), /*#__PURE__*/React.createElement("dd", null, phDesc)));
  }
}
...
class Ph_innerwrap extends React.Component {
  render() {
    ...
    const columns = ours.map((column, index) => {
      return /*#__PURE__*/React.createElement(Ph_part, {
        ours: column,
        idx: index + 1,
        key: index
      });
    ...
    return /*#__PURE__*/React.createElement("div", {
      class: "innerwrap ph_part_innerwrap clearfix"
    }, /*#__PURE__*/React.createElement(H2, null), columns);
  }
}
const ours = [{
  'title': 'mission',
...
ReactDOM.render( /*#__PURE__*/React.createElement(Ph_innerwrap, {
  ours: ours
